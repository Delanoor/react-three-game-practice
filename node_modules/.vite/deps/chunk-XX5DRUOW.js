...
var globalCache, suspend, preload, peek, clear;
var init_dist = __esm({
  "node_modules/suspend-react/dist/index.js"() {
    globalCache = [];
    ...
    peek = (keys2) => {
      ...
      return (_globalCache$find = globalCache.find((entry) => shallowEqualArrays(keys2, entry.keys, entry.equal))) == null ? void 0 : _globalCache$find.response;
    };
    clear = (keys2) => {
...
var import_react, import_debounce, keys, areBoundsEqual;
var init_web = __esm({
  "node_modules/react-use-measure/dist/web.js"() {
...
var React, __defProp, __defProps, __getOwnPropDescs, __getOwnPropSymbols, __hasOwnProp, __propIsEnum, __defNormalProp, __spreadValues, __spreadProps, FiberContext, FiberProvider, ReactCurrentOwner, ReactCurrentDispatcher;
var init_dist2 = __esm({
  "node_modules/its-fine/dist/index.js"() {
    ...
    FiberContext = wrapContext(React.createContext(null));
    FiberProvider = class extends React.Component {
      render() {
    ...
    ({ ReactCurrentOwner, ReactCurrentDispatcher } = React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED);
  }
});
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XX5DRUOW.js.map
